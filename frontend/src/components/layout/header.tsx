      ...
      <nav className="flex justify-between items-center max-w-screen-xl mx-auto h-14 px-4">
        <div className="flex items-center space-x-4">
          ...
          <form className="flex items-center bg-gray-100 rounded-lg px-2 py-1">
            <img src="/public/images/search.png" alt="Search Icon" className="w-4 h-4 mr-2 invert-[0.5]" />
            <input
              type="text"
              placeholder="Search"
        ...
        <div className="hidden md:flex items-center space-x-6">
          <a href="/" className="flex flex-col items-center text-gray-500">
            <img src="/public/images/home.png" alt="Home" className="w-6 h-6 mb-1 invert-[0.5]" />
            <span className="text-xs">Home</span>
          </a>
          {user === null ? (
            <>
              <a href="/login" className="flex flex-col items-center text-gray-500">
                <img src="/public/images/log-in.png" alt="Login" className="w-6 h-6 mb-1 invert-[0.5]" />
                <span className="text-xs">Login</span>
              </a>
              <a href="/register" className="flex flex-col items-center text-gray-500">
                <img src="/public/images/add.png" alt="Register" className="w-6 h-6 mb-1 invert-[0.5]" />
            ...
            <>
              ...
              >
                <img src="/public/images/logout.png" alt="Logout" className="w-6 h-6 mb-1 invert-[0.5]" />
      ...
      {isSidenavOpen && (
        <div className="fixed inset-0 z-40">
          ...
          <div className="fixed top-0 right-0 w-64 bg-white h-full shadow-lg p-4">
            ...
            {user === null ? (
              <>
                <a href="/login" className="block text-gray-700 mb-4">
                  Login
                </a>
                <a href="/register" className="block text-gray-700 mb-4">
                  Register
                </a>
              </>
            ) : (
              <>
                {user.role.value === "jobseeker" && (
                  <a href="/jobseeker/history" className="block text-gray-700 mb-4">
                    History
                  </a>
                )}
                {user.role.value === "company" && (
