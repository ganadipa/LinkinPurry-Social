    ...
    <div className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto flex flex-col items-center text-center px-6">
          <h2 className="text-4xl font-extrabold mb-4">Welcome to LinkInPurry</h2>
          <p className="text-lg text-gray-600 mb-6">
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Facilis quasi dicta esse!
          </p>
          <Button size="lg" className="bg-blue-700 text-white hover:bg-blue-600">
            Get Started
          </Button>
        </div>
      </section>
